...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
	...
	<div class="dialog" style="filter: alpha(opacity = 70); -moz-opacity: 0.7; -khtml-opacity: 0.7; opacity: 0.7;">
			...
			<div class="panel-body" >
				<form>
					<div class="form-group">
						<label>手机号</label> <input type="text" class="form-control span12">
					</div>
					<div class="form-group">
						<label>姓名</label> <input type="text" class="form-control span12">
					</div>
					<div class="form-group">
						<label>密码</label> <input type="text" class="form-control span12">
					</div>
					<div class="form-group">
						<label>推荐人</label> <input type="text" class="form-control span12">
					</div>
					<div class="form-group">
						<label>验证码</label> <input type="password" class="form-control span12">
					</div>
					<div class="form-group">
						<a href="index.do" class="btn btn-primary pull-right">注册!</a> <label class="remember-me"><input
							type="checkbox"> 同意 <a href="terms-and-conditions.do" style="font-family: 微软雅黑;">量子互助条款</a></label>
					</div>
		...
		<p>
			<a href="privacy-policy.do" style="font-size: .75em; margin-top: .25em;">关于我们</a>
		</p>
	</div>
